...
num_h_districts = {"VA": 100, "TX": 150, "AR": 100, "CO": 65, "LA": 105, "NM": 70} ## Number of states House districts
...
def get_state_runs(state, seats, iters=100000, pop_bal=2.0, min_col="nWVAP",
    ...
    """ Reads in short burst and biased run results. and returns dictionary of parameter and matrix of run results.
        Args:
          * state: str      -- abbreviation of states to pull data from
          * seats: int      -- number of states House districts
